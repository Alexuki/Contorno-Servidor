        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <?php
                    ...
                    if (!esAdmin()) {
                        $idUsuarioFiltro = (int) $usuarioSesion['id'];
                    }
                                ...
                                <?php
                                    ...
                                    if (count($lista) > 0) {
                                        foreach ($lista as $tarea) {
                                            ...
                                            echo '<td>' . htmlspecialchars($tarea['id_usuario']) . '</td>';
                                            echo '<td>';
                                            echo '<a class="btn btn-sm btn-outline-primary" href="tarea.php?id=' . $tarea['id'] . '" role="button">Ver</a>';
