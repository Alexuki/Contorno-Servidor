...
<html lang="en">
    ...
    <body>
        ...
        <?php
            /* 
            Al cargar la página se ejecuta este código que maneja la
            recepción de los datos del formulario que los envía
        ...
        <!-- Código abreviado equivalente a &lt;?php echo $mensajes; ?&gt;
          Mostrará los mensajes tras procesar la información del formulario -->
        <?= $mensajes; ?>
