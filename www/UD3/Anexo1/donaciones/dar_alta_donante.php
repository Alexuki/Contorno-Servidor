...
seleccionar_bd($conexion,"donacion");
...
/* Si esta página se recarga al enviar el formulario de la parte inferior
con el submit, entra en el if y procesa los datos.
Los errores se almacenan en el array $mensajes y se pasan a la función
get_mensajes_html_format() para mostrarlos. Cada mensaje es un array con dos
elementos: el primero es el tipo de mensaje (error o success) y el segundo
el texto del mensaje. Allí aplica un color usando las clases de Bootstrap.
*/
