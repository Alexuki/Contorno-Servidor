<!-- Parte común tanto para Nuevo usuario como para Editar usuario. Cuando se usa en la pantalla de edición, existen ya declaradas las variable de $nombre, $apellidos, etc -->
<div class="mb-3">
